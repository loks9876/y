...
console.log(chalk.yellow('🚩ㅤجاري الاتصال.'))
}
if (connection == 'open') {
...
conn.welcome = '✦━━━━━━[ ☾︎☀︎︎𝑺𝒖𝒌𝒖𝒏𝒂-𝑩𝒐𝒕☀︎︎☽︎ ]━━━━━━✦\n\n┏––––––━━━━━━━━•\n│⫹⫺ @subject\n┣━━━━━━━━┅┅┅\n│( 👋🏻مرحبا بعمري@user)\n├[ *المطور* ]—\n│ *❤️‍🔥~°ϻa ¦ 𝑁𝐴𝑇𝑺𝑈!°~⛩️📛*\n┗––––––━━┅┅┅\n\n––––––┅┅ *اقرأ الوصف* ┅┅––––––\n@desc' 
   conn.bye = '✦━━━━━━[ ☾︎☀︎︎𝑺𝒖𝒌𝒖𝒏𝒂-𝑩𝒐𝒕☀︎︎☽︎ ]━━━━━━✦\n *بايي*@user* 👋🏻  ( ╹▽╹ )'
conn.spromote = '*@user مبروك الادمن ✨💜*'
conn.sdemote = '*@user كنت ادمن فاشل 🙂💜*'
...
let bio =  `The developer of this bot is dead 𝑁𝐴𝑇𝑺𝑈`
await
  conn.updateProfileStatus(bio).catch(_ => _)
}, 60000)
