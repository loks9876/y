let handler = m => m; 
 ...
   let responses; 
   if (/^سوكونا بحبك|سوكونا عاوز اتجوزك|بحبك|بموت فيك|نتجوز|سوكونا هنتجوز امتي|سوكونا انت ليا|سوكونا بموت فيك$/i.test(m.text)) { 
     responses = [ 
       '*و أنا أكثر يعمري🫶🏻💗*   ',  
       '*حبتك حية قول آمين!*',  
 ...
                   '*يسلمك و يسمنك🙏🏻*' 
   ...
   }else if (/^سوكونا|سوكونا عمك|يا سوكونا $/i.test(m.text)) { 
     responses = [ 
       'عيون سوكونا 🫶🏻',  
          'لبيهه🥹',  
              'يهلا يهلا🫶🏻',  
